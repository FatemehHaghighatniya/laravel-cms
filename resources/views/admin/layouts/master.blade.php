...
<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-title"><i class="fa fa-user"></i>
                مدیریت کاربران
            </li>
            <li class="nav-item nav">
                <a class="nav-link" href="{{route('users.create')}}"><i class="fa fa-circle-o"></i> ثبت کاربر</a>
                <a class="nav-link" href="{{route('users.index')}}"><i class="fa fa-circle-o"></i> لیست کاربران</a>
{{--                <a class="nav-link" href="#"><i class="icon-user-following"></i> دسترسی کاربران</a>--}}
            </li>



            <li class="nav-title"><i class="fa fa-list"></i>
مطالب            </li>
            <li class="nav-item nav">
                <a class="nav-link" href="{{route('posts.create')}}"><i class="fa fa-circle-o"></i>درج مطلب جدید</a>
                <a class="nav-link" href="{{route('posts.index')}}"><i class="fa fa-circle-o"></i> لیست مطالب</a>
{{--                <a class="nav-link" href="#"><i class="icon-user-following"></i> دسترسی کاربران</a>--}}
            </li>
            ...
            <li class="nav-title"><i class="fa fa-list"></i>
                دسته بندی            </li>
            <li class="nav-item nav">
                <a class="nav-link" href="{{route('categories.create')}}"><i class="fa fa-circle-o"></i> دسته بندی جدید</a>
                <a class="nav-link" href="{{route('categories.index')}}"><i class="fa fa-circle-o"></i> لیست دسته بندی ها</a>
                {{--                <a class="nav-link" href="#"><i class="icon-user-following"></i> دسترسی کاربران</a>--}}
            </li>
            ...
            <li class="nav-title"><i class="fa fa-folder"></i>
                مدیریت فایل ها
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('photos.index')}}"><i class="fa fa-circle-o"></i> لیست فایل ها</a>
                <a class="nav-link" href="{{route('photos.create')}}"><i class="fa fa-circle-o"></i>آپلود فایل</a>
            </li>



            <li class="nav-title"><i class="fa fa-comment"></i>  نظرات  </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('comments.index')}}"><i class="fa fa-circle-o"></i> لیست نظرات</a>
            </li>
...
{{--                <ul class="nav-dropdown-items">--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link" href="/admin/fonts-awesome/css/font-awesome.min.css"><i class="icon-star"></i> Font Awesome</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link" href="/admin/fonts-awesome/css/font-awesome.min.css"><i class="icon-star"></i> Simple Line Icons</a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </li>--}}
